        ...
        {selectedCard && !transactionsLoading && !transactionsError && selectedCardTransactions.length > 0 ? (
          <div className="accounts-feature__transactions">
            ...
            <div className="accounts-feature__pagination transactions-feature__pagination">
              <span>{`Showing ${(currentPage - 1) * TRANSACTIONS_PAGE_SIZE + 1} to ${Math.min(selectedCardTransactions.length, currentPage * TRANSACTIONS_PAGE_SIZE)} of ${selectedCardTransactions.length} entries`}</span>
